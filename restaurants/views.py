...
from restaurants import clarifai_tag_suggestions
...
class GetTags(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        api_key = clarifai_tag_suggestions.get_access_token('CLARIFAI_API_KEY')
        ...
        tags = clarifai_tag_suggestions.get_tags_suggestions(api_key, image_url)
        return JsonResponse(tags, safe=False)
