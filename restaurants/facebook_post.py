...
class Facebook:
    ...
    def publish_photo_msg(self, message, image_url):
        ...
        requests.post('https://graph.facebook.com/v2.7/' + self.page_id + '/photos', data=data)
...
if __name__ == '__main__':
    ...
    image_url = 'https://cleobuttera.com/wp-content/uploads/2019/06/kk-ice-cream-full-mood-720x405.jpg'
    my_name = 'Loveneesh Dhir'
